...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validate()) {
      ...
      alert(lang === "en" ? "Message Sent!" : "संदेश पाठवला!");
    }
  };
  const handleChange = (
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-xs sm:text-[14px] text-gray-500">
                  {t.firstName}
                </label>
                <input
                  name="firstName"
                  ...
                  className={`w-full h-11 border ${errors.firstName ? "border-red-500" : "border-gray-300"} rounded-md px-4 text-sm outline-none focus:border-[#C85D1F]`}
                />
                {errors.firstName && (
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className={`w-full h-11 border ${errors.lastName ? "border-red-500" : "border-gray-300"} rounded-md px-4 text-sm outline-none focus:border-[#C85D1F]`}
                />
                {errors.lastName && (
                  <span className="text-red-500 text-[10px]">
                    {errors.lastName}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className={`w-full h-11 border ${errors.mobile ? "border-red-500" : "border-gray-300"} rounded-md px-4 text-sm outline-none focus:border-[#C85D1F]`}
                />
                {errors.mobile && (
                  <span className="text-red-500 text-[10px]">
                    {errors.mobile}
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className={`w-full h-11 border ${errors.email ? "border-red-500" : "border-gray-300"} rounded-md px-4 text-sm outline-none focus:border-[#C85D1F]`}
                />
                {errors.email && (
                  <span className="text-red-500 text-[10px]">
                    {errors.email}
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                className={`w-full border ${errors.message ? "border-red-500" : "border-gray-300"} rounded-md p-4 text-sm outline-none resize-none focus:border-[#C85D1F]`}
              />
              {errors.message && (
                <span className="text-red-500 text-[10px]">
                  {errors.message}
